...
# Build content - no emojis to avoid encoding issues
$body = @'
{"children":[
    ...
    {"object":"block","type":"callout","callout":{"rich_text":[{"type":"text","text":{"content":"Below are live database views. Click to see all data and apply filters."}}],"color":"blue_background"}},
    ...
    {"object":"block","type":"callout","callout":{"rich_text":[{"type":"text","text":{"content":"Add hours in Work Log today. Select a project and log what you worked on."}}],"color":"purple_background"}}
]}
'@
